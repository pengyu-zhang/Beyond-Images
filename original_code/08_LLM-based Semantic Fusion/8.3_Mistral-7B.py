...
OUTPUT_FILE = "/gpfs/work5/0/prjs1145/code/beyond_images/08_t5/DB15K_Mistral-7B_summaries.json" # 建议修改输出文件名
...
MODEL_NAME = "/gpfs/work5/0/prjs1145/code/beyond_images/mistralai_Mistral-7B-Instruct-v0.3/"
