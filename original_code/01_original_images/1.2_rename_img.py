...
# 配置参数
input_file1 = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_ent_links_wikidata.txt"
input_file2 = "/gpfs/home5/pzhang/beyond_images/datasets/MKG-Y_img_original/"
output_file3 = "/gpfs/home5/pzhang/beyond_images/datasets/MKG-Y_img_original_rename"
output_file4 = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_log_error.txt"  # 未匹配日志
output_file5 = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_log_success.txt"  # 成功匹配日志
output_file6 = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_log_fail.txt"  # 未匹配实体日志
log_level = "INFO"
...
def parse_ent_links(file_path):
    """解析输入文件1，返回dbpedia_url到wikidata_qid的映射"""
    dbpedia_to_qid = {}
    ent_links = []  # 存储完整的 dbpedia_url 和 wikidata_url
    try:
        with open(file_path, 'r', encoding='utf-8') as file:
            for line in file:
                ...
                #     dbpedia_suffix = dbpedia_url.split('/')[-1]
                #     wikidata_qid = wikidata_url.split('/')[-1]
                #     dbpedia_to_qid[dbpedia_suffix] = wikidata_qid
                #     ent_links.append((dbpedia_suffix, dbpedia_url, wikidata_url))
                # MKG-Y
                if len(parts) == 3:
