...
def main():
    # 输入文件路径
    file1 = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_ent_links_wikidata.txt"
    file2 = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_img_new_descriptions.txt"
    output_file = "/gpfs/home5/pzhang/beyond_images/datasets/MKG-Y_img_new_summary_blip.json"
