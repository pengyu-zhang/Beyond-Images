...
if __name__ == "__main__":
    # 路径配置（示例）
    input_file = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_ent_links_wikidata.txt"
    save_path = "/gpfs/home5/pzhang/beyond_images/datasets/MKG-Y_img_new"
    json_output_path = "/gpfs/home5/pzhang/beyond_images/datasets/MKG-Y_img_new_summary.json"
    ERROR_LOG_FILE = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_img_new_error_log.txt"
    FAILED_IMAGES_LOG_FILE = "/gpfs/home5/pzhang/beyond_images/datasets/log/MKG-Y_img_new_failed_images_log.txt"
